import * as UniformsUtils from 'three';
...
function createBufferGeometry(doHighlight) {
    ...
    geometry.addAttribute('highlight', new BufferAttribute(highlight, 1));
...
function createOutlineMaterial() {
    ...
    outlineMaterial = new ShaderMaterial({
        uniforms: UniformsUtils.clone(outline_shader.uniforms),
